  ...
  try {
    ...
    return (
      <div className="container py-20 text-white bg-red-900/20 p-8 rounded-2xl border border-red-500">
        <h1 className="text-2xl font-bold mb-4">DEPLOYED DEBUG LOG (Experts):</h1>
        <p className="font-mono text-sm whitespace-pre-wrap">{err.message}</p>
        <div className="mt-8 p-4 bg-white/10 rounded-lg">
          <p className="text-sm font-bold">Troubleshooting:</p>
          <p className="text-xs opacity-70">Check environment variables in your deployment dashboard.</p>
        </div>
      </div>
    )
  }
